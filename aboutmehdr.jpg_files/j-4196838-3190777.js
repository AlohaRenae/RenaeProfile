//Generated:2020-10-12 23:25:48// 6-243
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4196838 || '',
    guid: window.ftGUID_4196838 || '',
    confID: window.ftConfID_4196838 || '0',
    ftReturn: window.ftReturn_4196838 || '',
    keyword: window.ftKeyword_4196838 || '',
    ftId: window.ftId_4196838 || '',
    ftImpId: window.ftImp4196838 && window.ftImp4196838.impID || '',
    gdpr: window.ftImp4196838 && window.ftImp4196838.gdpr || '',
    gdpr_consent: window.ftImp4196838 && window.ftImp4196838.gdpr_consent || '',
    gdpr_pd: window.ftImp4196838 && window.ftImp4196838.gdpr_pd || '',
    us_privacy: window.ftImp4196838 && window.ftImp4196838.us_privacy || '',
    campaignID: '115844',
    cID: '100890',
    pID: '4196838',
    creativeID: '3190777',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115844&sid=18330&plc=4196838&num=&adid=&advid=&adsrv=29&btreg=4196838&btadsrv=flashtalking&crt=3190777&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/8/115844;4196838;3190777;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?189250111-4196838;3190777;',
    centreAd: false,
    width: 160,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/419/4196838/3190777/image/3190777.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115844;4196838;202;pixel;DV360;DV360FY20CCRTRCProUSDSKBAN160x600/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/115844;4196838;3190777;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=160&ft_height=600&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display',
    divID: 'ftdiv4196838',
    altimgID: 'ftalt4196838',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4196838 && parseInt(window.ftImp4196838.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4196838') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4196838'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4196838").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4196838").style.display = "none";
		    }
		});
	}
}(ft4196838));
